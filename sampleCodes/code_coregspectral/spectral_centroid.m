function [U U1 F P R nmi pur avgent AR Pavg nmiavg puravg] = spectral_centroid(X1,X2,numClust,sigma1,sigma2,lambda1,lambda2,truth,numiter)
% INPUT:
% OUTPUT:
    ...
    pur(2) = mean(pure); std_pur(2) = std(pure);
