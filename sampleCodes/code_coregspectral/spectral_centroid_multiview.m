function [F P R nmi pur avgent AR Pavg nmiavg puravg] = spectral_centroid_multiview(X,num_views,numClust,sigma,lambda,truth,numiter)
% INPUT:
% OUTPUT:
%Row major X
   ...
   %{
    ...
    fprintf('\n\n');
    Pavg = P(numiter+1);
    nmiavg = nmi(numiter+1); 
    puravg = pur(numiter+1);
    %{
    fprintf('avgent:   ');    
    for i=1:numiter+2      
