...
\begin{document}
	...
	\begin{algorithm}
		...
		\Input{Nonnegative Matrix ${X_{1}, \cdots ,X_{n_{v}}}$, parameters ${\lambda_{1}, \lambda_{2}}$, number of clusters $K$}
	...
	\begin{algorithm}
		\SetKwInOut{Input}{Input}
		\SetKwInOut{Output}{Output}
		\Input{Nonnegative Matrix ${X_{1}, \cdots ,X_{n_{v}}}$, parameters ${\lambda_{1}, \mu_{1}, \cdots ,\lambda_{n_{v}},\mu_{n_{v}}}$, number of clusters $K$}
		\Output{Basis Matrices ${U_{1}, \cdots ,U_{n_{v}}}$, Coefficient Matrices ${V_{1}, \cdots ,V_{n_{v}}}$ and Consensus Matrix $V^{*}$}
		Construct Graph Laplacians $L_{v}$ for each view\;
		Normalize each view $X_{v}$ such that $\|X_{v}\|_{\text{\tiny1}} = 1 $\;
	...
	\begin{algorithm}
		...
		\SetKwInOut{Output}{Output}
		\Input{Nonnegative Matrix ${X_{1}, \cdots ,X_{n_{v}}}$, parameters ${\lambda_{1}, \mu_{1}, \cdots ,\lambda_{n_{v}},\mu_{n_{v}}}$, number of clusters $K$}
		\Output{Basis Matrices ${U_{1}, \cdots ,U_{n_{v}}}$, Coefficient Matrices ${V_{1}, \cdots ,V_{n_{v}}}$, View Weights ${w_{1}, \cdots ,w_{n_{v}}}$ and Consensus Matrix $V^{*}$}
		Construct Graph Laplacians $L_{v}$ for each view\;
		Normalize each view $X_{v}$ such that $\|X_{v}\|_{\text{\tiny1}} = 1 $\;
